...
const STRINGS = {
  en: {
    ...
    objNegotiate: "Your call now. Push for more, bluff, or play a trick.",
    objYourWay: "No script from here: negotiate your way. The chips below are ready lines if you want one.",
    objCounter: "Alex moved. Meet in the middle, or push again.",
    objFinal: "That's Alex's best and final. Take it or walk away.",
    objApproved: "Alex can book that. Say yes to close the deal.",
  ...
  es: {
    ...
    objNegotiate: "Ahora es tu llamada. Pide más, farolea o juega un truco.",
    objYourWay: "Desde aquí no hay guion: negocia a tu manera. Las fichas de abajo son frases listas por si quieres una.",
    objCounter: "Alex se movió. Propón partir la diferencia, o presiona otra vez.",
    objFinal: "Es la última oferta de Alex. Tómala o retírate.",
    objApproved: "Alex puede cerrar en esa cifra. Di que sí para cerrar el trato.",
    ...
    capCallEnded: "llamada terminada",
